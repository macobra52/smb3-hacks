...
Modifys all Piranha Plants (normal and giant) so that they will emerge even if Mario is standing next to their pipe, similar to Red Piranhas in SMB2J/Lost Levels. Note that since the center of the giant Piranha is not exactly center he can still emerge if Mario is standing on the right side of the pipe.
